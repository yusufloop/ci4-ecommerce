        ...
        <ul>
            ...
            <?php if($auth->loggedIn()): ?>
                <?php if($auth->inGroup(['admin', 'operator'], $currentUser->id )): ?>
                    <li class="menu-item hidden"><a href="<?= site_url('admin/dashboard') ?>">Dashboard</a></li>
                <?php endif; ?>
                <li class="menu-item hidden"><a href="<?= site_url('auth/logout') ?>">Logout ( <?= $currentUser->first_name  ?> )</a></li>
            <?php else: ?>
                <li class="menu-item hidden"><a href="<?= site_url('auth/create_user') ?>">Register</a></li>
                <li class="menu-item hidden"><a href="<?= site_url('auth/login') ?>">Login</a></li>
            <?php endif; ?>
        </ul>
    </div>
